const dummyData = {
  ...
  "description":
      "This template is used for storing the questionnaire for home loan process",
  "schema": {
    "fields": [
      {
      ...
      },
      {
        ...
        "schema": {
          ...
          "options": [
            ...
            {"key": "id3", "value": "Propietary concern"},
      ...
      },
      {
        ...
        "schema": {
          ...
          "hidden": false, //"${typeOFLoan !== 'balance-transfer-top-up'}",
          "readonly": false,
          "options": [
            {"key": "id1", "value": "HDFC"},
            {"key": "id2", "value": "ICICI"},
